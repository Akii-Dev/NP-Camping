...
<body id="" class="min-h-screen gradient-bg-rules">
    ...
    <header>
        ...
        <div
            ...
            <p>Welkom op deze pagina vind u Informatie over huisregels. wij hopen dat u zich thuis voelt op onze prachtige camping.</p>
        </div>
    </div>
    </header>
    <div class="max-w-2xl flex flex-col items-center mx-auto mb-12 -mt-70 z-20 gradient-bg-rules rounded-4xl border-t-8">
        ...
        <div class="flex flex-col items-start mt-6 p-4 huisregelBG w-auto md:w-2xl">
            ...
            <div class="flex flex-col text-left w-full px-6">
                ...
                te slapen dus houd uw geluids niveau laag. Zodat u en andere bezoekers een goede nacht rust krijgen.</h4>
            </div>
        </div>
        ...
        <div class="flex flex-col items-start mt-6 p-4 mb-10 huisregelBG2 w-auto md:w-2xl">
            ...
            <div class="flex flex-col text-left w-full px-6">
                ...
                uw tent vak als u een gast bent. Dit kan alleen als u 1 auto heeft voor elke extra auto betaalt u €1,75 per nacht meer.</h4>
            </div>
        </div>
    </div>
    <x-footer></x-footer>
