...
<body class="bg-blue-300">
    <div class="h-screen flex justify-center items-center">
        <div class="flex h-[500px] p-20 justify-center items-center rounded-l-2xl  bg-blue-200">
            <div class="">
                ...
                <form class="flex flex-col" action="{{ route('user.login') }}" method="POST">
                    ...
                    <input class="bg-white mb-4 rounded-2xl p-2 pr-28" type="text" name="email"
                        placeholder="Email">
                    <label>Login</label>
                    <input class="bg-white mb-6 rounded-2xl p-2 pr-28" type="password" name="password"
        ...
        <div class="flex flex-col h-[500px] p-20 justify-center items-center rounded-r-2xl bg-white">
            ...
            <div class="flex w-64">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3"
                    stroke="currentColor" class="min-h min-w size-7">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                </svg>
