<footer class="text-white bg-zinc-900 h-auto w-auto py-4 px-2 md:px-40 py-2 grid grid-row-3 md:grid-cols-3 md:h-36 md:divide-x-1 md:divide-solid ,d:divide-white">
    <div class="px-2 text-sm row-span-1 md:row-span-0 border-b-2 md:border-b-0">
