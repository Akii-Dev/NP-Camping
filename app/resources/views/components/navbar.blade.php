...
<nav id="sideNav"
    ...
    <div id="navContent"
        ...
        <a href="#" class="my-6 underline decoration-black orange1text">Home</a>
        <a href="#" class="my-6 underline decoration-black orange1text">Boeken</a>
        <a href="#" class="my-6 underline decoration-black orange1text">Account</a>
        <a href="#" class="my-6 underline decoration-black orange1text">Huisregels</a>
    </div>
</nav>